...
#[derive(Debug)]
pub struct FlashLoanProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FlashLoanProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FlashLoan processing");
    
    let mut processor = FlashLoanProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FlashLoanProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FlashLoanProcessor::new(false);
